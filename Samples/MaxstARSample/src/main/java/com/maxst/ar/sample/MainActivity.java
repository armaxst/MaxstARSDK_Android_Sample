...
import com.maxst.ar.sample.webview.WebViewAugmentActivity;
...
public class MainActivity extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.web_view_augmentation).setOnClickListener(this);
	...
	public void onClick(View view) {
		switch (view.getId()) {
			...
			case R.id.web_view_augmentation:
				startActivity(new Intent(MainActivity.this, WebViewAugmentActivity.class));
				break;
		}
	}
}
