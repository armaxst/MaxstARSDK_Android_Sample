...
class SpaceTrackerRenderer implements Renderer {

	public static final String TAG = SpaceTrackerRenderer.class.getSimpleName();
	...
	SpaceTrackerRenderer(Activity activity) {
